...
export const UserProfileSidebar = ({ id, projectKey }: UserProfileSidebarProps) => {
  ...
  return (
    <Card className="flex h-full min-h-0 flex-col overflow-hidden rounded-none border-0 bg-transparent px-0 shadow-none">
      {/* Avatar */}
      <div className="relative mx-auto w-full max-w-[160px] shrink-0" style={{ aspectRatio: "1 / 1" }}>
      ...
      {/* Account details */}
      <CardContent className="mt-4 flex-1 overflow-y-auto w-full rounded-sm border bg-card px-5 py-10 shadow-sm">
