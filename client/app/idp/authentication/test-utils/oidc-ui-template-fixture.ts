...
// The baseline template most tests render with. Clone the app default so tests
// that locate elements by its copy (e.g. a "Login" button) cannot drift from it.
...
export const DEFAULT_OIDC_UI_TEMPLATE_FIXTURE: IOidcUiTemplate =
  structuredClone(DEFAULT_OIDC_UI_TEMPLATE);

export const OIDC_UI_TEMPLATE_FIXTURE: IOidcUiTemplate = {
  branding: { logoUrlLight: null, logoUrlDark: null, brandName: "Test IAM" },
  theme: {
    light: {
      ...
      borderStrong: "rgba(18, 102, 170, 0.4)", accentSoft: "rgba(18, 102, 170, 0.1)", buttonText: "#ffffff",
    },
    dark: {
      ...
      borderStrong: "rgba(51, 136, 204, 0.4)", accentSoft: "rgba(51, 136, 204, 0.1)", buttonText: "#ffffff",
    },
  },
  pages: {
    login: {
