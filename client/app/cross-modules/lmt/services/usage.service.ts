...
export class UsageService {
  getOperationalAnalytics(payload: IGetOperationalAnalyticsPayload): Promise<UsageMatrix[]> {
    return serviceInstances.idpService.post(TRACE_ENDPOINTS.GET_OPERATIONAL_ANALYTICS, payload);
  }
  getServiceAnalytics(payload: IGetServiceAnalyticsPayload): Promise<UsageMatrix[]> {
    return serviceInstances.idpService.post(TRACE_ENDPOINTS.GET_SERVICE_ANALYTICS, payload);
  }
}
