...
namespace XUnitTest.Auth.Shared
{
    public class IdpConstantsTests
    {
        ...
        {
            var config = IdpConstants.GetMessageConfiguration("amqp://guest:guest@localhost:5672/");
        ...
        {
            var config = IdpConstants.GetMessageConfiguration("amqps://guest:guest@localhost:5671/");
