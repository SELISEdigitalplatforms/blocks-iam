...
/**
 * Point the locally-served Blocks IAM at itself (:5000), not the remote dev host.
 *
 ...
 * When we run IAM locally on :5000, the SPA would then send its API calls to
