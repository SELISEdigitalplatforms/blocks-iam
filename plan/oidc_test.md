...
```bash id="49w3bp"
curl -X POST \
"http://localhost:5000/api/oidc/token?tenant_id=***REMOVED***" \
...
```bash id="wnpm7k"
curl -X GET \
"http://localhost:5000/api/auth/userinfo?tenant_id=***REMOVED***" \
...
```bash id="7t9e0r"
curl -X POST \
"http://localhost:5000/api/oidc/introspect?tenant_id=***REMOVED***" \
-H "Content-Type: application/x-www-form-urlencoded" \
...
```bash id="6z81fx"
curl -X POST \
"http://localhost:5000/api/oidc/revoke?tenant_id=***REMOVED***" \
-H "Content-Type: application/x-www-form-urlencoded" \
